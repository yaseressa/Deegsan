      ...
      <div className="flex h-screen w-screen bg-[#151712] font-body">
        <div className="mx-auto flex max-w-2xl flex-col justify-center gap-24 align-middle max-[665px]:my-auto">
          ...
          <div className="flex gap-6 px-8 text-white cursor-pointer max-[665px]:my-auto max-[665px]:flex-wrap">
            <Link to="/geed">
              <div className="flex items-center space-x-4 rounded-xl text-xs font-medium leading-5 bg-[#A0D179]/50 p-6 hover:bg-[#A0D179]/60">
            ...
            <Link to="/recycling">
              <div className="flex items-center space-x-4 text-xs font-medium leading-5 rounded-xl bg-[#A0D179]/50 p-6 hover:bg-[#A0D179]/60">
